...
{
    public sealed class CrEaTiiOn_Ultimate_GradientNumericUpDown : Control
    {
        private int _w;
        private int _h;
        private int _x;
        ...
        private Color _gradientColorSecondary = Color.FromArgb(45, 45, 45);
        ...
        public CrEaTiiOn_Ultimate_GradientNumericUpDown()
        {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            graphics.FillRectangle(new LinearGradientBrush(new PointF(0, Height / 2f), new PointF(Width, Height / 2f), _gradientColorPrimary, _gradientColorSecondary), new Rectangle(Width - 24, 0, 24, _h));
